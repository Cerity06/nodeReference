...
```js
// file stats give information on the file
...
// open file for reading and writing, positioning the stream at the end of the file. The file is created if it does not exist
